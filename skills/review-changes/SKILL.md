...
5. 修正後の再レビューでは、前回指摘を基準に `resolved / remaining / new` を整理してから今回の所見をまとめる。
6. 出力フォーマットに従って、Must-fix / Should-fix / Nice-to-have に分けて提示する。
7. 高リスク変更やレビュー品質への不確実性が残る場合だけ、追加確認の必要性を示す。
8. 指摘の採否や対応方針が必要な場合は、そのまま判断材料として使える形で未解決事項や確認観点を残す。
