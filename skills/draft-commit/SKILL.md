...
1. First confirm the commit convention explicitly stated in the target repository; if there are local rules for commit type or scope, follow them instead.
...
9. Confirm the summary is short and specific (in the author's working language, Japanese).
...
- Write the summary in the author's working language (Japanese)
