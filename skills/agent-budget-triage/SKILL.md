...
- repo を読む実装作業か、文章整理か、原因調査かを先に切り分けたいとき
...
2. repo を読む必要がないなら、まず通常チャットを候補にする。
3. repo を読むが、変更が局所的で既存パターンに沿うなら、Copilot 補完または軽い coding agent を候補にする。
...
- repo を読む必要がない作業に、重い coding agent を既定提案しない
